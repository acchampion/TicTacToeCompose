...
import edu.osu.tictactoecompose.common.Preferences
...
open class BasicPlaybackService : MediaLibraryService() {
     ...
     *
     * This method is called when the session is built by the [BasicPlaybackService].
     */
    ...
    protected open fun buildPlayer(): Player {
        ...
        return ExoPlayer.Builder(/* context= */ this).build()
    }
    ...
    private fun storeCurrentMediaItem() {
        ...
        CoroutineScope(Dispatchers.IO).launch {
            PreferenceDataStore.get(this@BasicPlaybackService).updateData { preferences ->
                val builder =
                    preferences
                        .toBuilder()
                        .setMediaId(mediaID)
    ...
    private inner class MediaSessionServiceListener : Listener {
        ...
        override fun onForegroundServiceStartNotAllowedException() {
            ...
            val notificationManagerCompat =
                NotificationManagerCompat.from(this@BasicPlaybackService)
            ensureNotificationChannel(notificationManagerCompat)
            val builder =
                NotificationCompat.Builder(this@BasicPlaybackService, CHANNEL_ID)

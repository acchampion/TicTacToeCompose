...
object MediaItemTree {
  ...
  private fun addNodeToTree(mediaObject: JSONObject) {
    ...
    if (mediaObject.has("subtitles")) {
      ...
      for (i in 0 until subtitlesJson.length()) {
        ...
        subtitleConfigurations.add(
          SubtitleConfiguration.Builder(subtitleObject.getString("subtitle_uri").toUri())
    ...
    val sourceUri = mediaObject.getString("source").toUri()
    val imageUri = mediaObject.getString("image").toUri()
